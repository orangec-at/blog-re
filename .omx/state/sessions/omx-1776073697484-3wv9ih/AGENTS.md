...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1776073697484-3wv9ih | 2026-04-13T09:48:28.383Z

**Codebase Map:**
  src/: contentlayer.config
  src/app/: home-page.test, layout, page, page, page
  src/components/: demo-placeholder, before-after-board.test, case-study-grid.test, contact-cta.test, decision-principles.test, drawhatha-highlight.test, hero.test, iac-highlight.test, refactoring-log.test, before-after-board
  src/data/: homepage-content.test, contacts, homepage-content, projects
  src/lib/: mdx
  src/types/: frontmatter
  (root): contentlayer.config, eslint.config, next.config, postcss.config, tailwind.config, vitest.config, vitest.setup
